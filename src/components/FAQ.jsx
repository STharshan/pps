  ...
  const faqs = [
    {
      ...
      answer: "Yes, we recognize the severity of COVID-19 and its effects, and therefore take all disinfection and sanitization jobs very seriously. Our employees are equipped with appropriate PPE to protect you and themselves while complying with all safety measures."
    },
    {
      question: " What Size Facilities Do You Clean?",
      answer: "No job is too big or too small for us. We have the best equipment to tackle facilities of all sizes ranging from individual homes to airports. PPS Group consists of professionally trained employees who excel in any task put in front of them, regardless of the size."
    },
    {
      question: "Is a long-term contract required for cleaning services?",
      answer: "Long-term contracts are not a requirement for our cleaning services. PPS Group would love to work with you to develop a plan and schedule to meet your needs at the best price."
    },
    {
      question: "Do I need to provide any supplies or equipment for your cleaning services?",
      answer: "No, you will not need to providing cleaning supplies or equipment. PPS Group will bring all the necessary equipment to serve you. Cleaning supplies and equipment charges will be included within the cleaning quotation amount."
    }
  ];
