        ...
        <div className="max-w-5xl mx-auto text-center text-white space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 font-medium transition-all bg-[#0094D9] text-white hover:bg-[#0094D9]/90 h-12 rounded-md px-8 py-3 text-lg shadow-lg"
            >
              Get a Free Quote
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 font-medium transition-all border border-white/30 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm h-12 rounded-md px-8 py-3 text-lg"
            >
              View Our Services
            </button>
          </div>
